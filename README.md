...
3. Укажите адрес электронной почты — на нее придет ключ доступа. Убедитесь в отсутствии опечаток в адресе.

Примечание: использовать почту с доменом @icloud не рекомендуется.
 
🎁 Подписку можно подарить вместе с небольшой запиской — эта опция есть на экране покупки.

4. Ознакомьтесь с Политикой конфиденциальности и условиями использования, поставьте флажок.
    
5. Кнопка «Перейти к оплате» станет активной. Нажмите ее и следуйте инструкциям по оплате на сайте. Действия отличаются в зависимости от выбранного платежного метода.

6. После оплаты на указанную почту придет ключ доступа и краткая инструкция по подключению.

7. Готово! Пользуйтесь приложением Amnezia VPN с премиум-доступом ко всем сервисам, нужным для безопасного и быстрого интернета! 🥳🥳🥳

В случае возникновения каких-либо проблем с оплатой всегда можно обратиться на почту support@amnezia.org, наши специалисты обязательно вам помогут! 🤝
...
5. The “Proceed to Payment” button will become active. Click it and follow the payment instructions on the website. The steps vary depending on the payment method you choose.
  
6. After payment, you will receive an access key and brief connection instructions at the email address you provided.
 
7. Done! Enjoy the Amnezia VPN app with premium access to all the services you need for a safe and fast internet experience! 🥳🥳🥳

If you encounter any issues with payment, you can always contact our support team via support@amnezia.org — our specialists will be happy to help! 🤝
